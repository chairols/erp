<div class="window Hidden" id="ProductWindow">
    <div class="window-border">
      <h4>
        <div class="pull-left"><i class="fa fa-cube"></i> Crear Nuevo Art&iacute;culo</div>
        <div class="pull-right">
          <div id="ProductWindowClose" class="CloseWindow CloseProductWindow text-red"><i class="fa fa-times"></i></div>
        </div>
      </h4>
    </div>
      ...
      <form id="ProductWindowForm">
        <div class="innerContainer" style="background-color:#EEE;padding-top:20px!important;">
          <div class="row form-group inline-form-custom">
            <div class="col-xs-12 col-sm-6">
              <input type="text" id="new_product_code" name="new_product_code" class="form-control" value="" placeholder="C&oacute;digo" validateEmpty="Ingrese un c&oacute;digo.">
            ...
            <div class="col-xs-12 col-sm-6">
              <input type="text" id="new_product_order_number" name="new_product_order_number" class="form-control" value="" placeholder="Número de Orden" validateOnlyNumbers="Ingrese n&uacute;meros &uacute;nicamente." validateEmpty="Ingrese un N&uacute;mero de Orden" data-inputmask="'alias': 'numeric', 'groupSeparator': '', 'autoGroup': true, 'digits': 0, 'digitsOptional': false, 'prefix': '', 'placeholder': '0'">
          ...
          <div class="row form-group inline-form-custom">
            <div class="col-xs-12 col-sm-6">
              <select class="form-control chosenSelect" id="new_product_category" name="new_product_category" data-placeholder="Seleccionar L&iacute;nea" validateEmpty="Seleccione una l&iacute;nea.">
                <option value=""></option>
              </select>
            ...
            <div class="col-xs-12 col-sm-6">
              <select class="form-control chosenSelect" id="new_product_brand" name="new_product_brand" data-placeholder="Seleccionar Marca" validateEmpty="Seleccione una marca." style="width:100%!important;">
                <option value=""></option>
              </select>
          ...
          <input type="hidden" id="new_abstract" name="new_abstract" value="">
          ...
          <div class="form-group row" id="abstract-assoc">
            ...
            <div class="col-xs-12">
              <input type="text" id="TextAutoCompleteabstract" name="TextAutoCompleteabstract" objectauto="Articulos_genericos" actionauto="gets_articulos_autocomplete_ajax" value="" class="form-control" validateEmpty="Seleccione un Art&iacute;culo" placeholder="Código a asociar" placeholderauto="C&oacute;digo no encontrado" iconauto="cube" />
              <input type="hidden" name="abstract" id="abstract" value="">
        ...
        <!--<form id="abstract_form" name="abstract_form">-->
          ...
          <div class="form-group row Hidden" id="new-abstract">
            <div class="col-xs-12">C&oacute;digo:</div>
            <div class="col-xs-12">
              <input type="text" id="abstract_code" name="abstract_code" class="form-control" value="" placeholder="Código Genérico">
