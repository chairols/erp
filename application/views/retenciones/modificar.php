    ...
    <div class="invoice">
        ...
        <div class="row">
            <div class="col-xs-2 txC">
                ...
                <input type="text" id="punto_de_venta" class="form-control inputMask" data-inputmask="'mask': '9{1,4}'">
            </div>
            <div class="col-xs-3 txC">
                <strong>Comprobante</strong><br>
                <input type="text" id="comprobante" class="form-control inputMask" data-inputmask="'mask': '9{1,8}'">
            </div>
            <div class="col-xs-2">
            ...
            <div class="col-xs-3">
                ...
                <input type="text" id="base_imponible" class="form-control inputMask" data-inputmask="'mask': '[-]9{1,17}.99'">
            </div>
            <div class="col-xs-2">
                <br>
