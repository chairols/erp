            ...
            <div class="login-box-body">
                ...
                <form method="post">
                    <div class="form-group has-feedback">
                        <input type="text" id="usuario" name="usuario" class="form-control" placeholder="Usuario" value="<?= (isset($_COOKIE['login_usuario'])) ? $_COOKIE['login_usuario'] : "" ?>" autofocus required>
                    ...
                    <div class="row">
                        <div class="col-xs-8">
                            <div class="checkbox icheck">
                                <label>
                                    <input type="checkbox" name="remember"<?=(isset($_COOKIE['login_usuario']) && isset($_COOKIE['login_password']))?" checked":""?>> Recordarme
                                </label>
                            </div>
                        </div>
                        <!-- /.col -->
