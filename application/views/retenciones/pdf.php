<div style="font-size: smaller">
    ...
    <table>
        <tr>
            <th style="width: 20%; text-align: right">Comprobantes</th>
            <th style="width: 20%; text-align: right">Fecha</th>
            <th style="width: 20%; text-align: right">Base Imponible</th>
        ...
        <tr>
            <td style="width: 20%; text-align: right" class="bg-gray"><?=str_pad($item['punto_de_venta'], 4, '0', STR_PAD_LEFT)?>-<?=str_pad($item['comprobante'], 8, '0', STR_PAD_LEFT)?></td>
            <td style="width: 20%; text-align: right"><?=$item['fecha_formateada']?></td>
            <td style="width: 20%; text-align: right"><?=number_format($item['base_imponible'], 2)?></td>
