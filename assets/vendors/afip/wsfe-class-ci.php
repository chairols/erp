...
class WsFE
{
    ...
    private function SignTRA($certificado, $clave)
    {
        ...
        //$currentPath = APPPATH.'libraries/wsfe/';
        ...
        /*
        $STATUS = openssl_pkcs7_sign($currentPath . "TRA.xml", $currentPath . "TRA.tmp", $currentPath.'hernan.crt',
            array($currentPath.'hernan.privada', ""),
            array(),
            !PKCS7_DETACHED
        );*/
        if (!$STATUS) {
