            ...
            <div class="row listRow listRow2 txC">
                <div class="col-lg-4 col-md-5 col-sm-5 col-xs-3">
                    <div class="listRowInner">
                        <span class="listTextStrong"><?=$cotizacion['cliente']['cliente']?></span>
                        <span class="smallTitle">(ID: <?=$cotizacion['idcliente']?>)</span>
                    </div>
                </div>
                ...
                <div class="listActions flex-justify-center">
                    <div>
                        <span class="roundItemActionsGroup">
                            <a class="hint--top hint--bounce hint--info" href="/cotizaciones_clientes/modificar/<?=$cotizacion['idcotizacion_cliente']?>/" aria-label="Modificar">
